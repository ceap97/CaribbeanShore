...
namespace RefugioVerde.Migrations
{
    ...
    [Migration("20241204113816_ActualizarModelos")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RefugioVerde.Models.MetodoDePago", b =>
                {
            ...
            modelBuilder.Entity("ReservaComodidad", b =>
                {
                    b.Property<int>("ComodidadId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ComodidadId", "ReservaId");

                    b.HasIndex("ReservaId");

                    b.ToTable("ReservaComodidad");
                });
            ...
            modelBuilder.Entity("RefugioVerde.Models.Cliente", b =>
                {
                    b.HasOne("RefugioVerde.Models.Municipio", null)
                        .WithMany("Clientes")
            ...
            modelBuilder.Entity("RefugioVerde.Models.Pago", b =>
                {
                    ...
                    b.HasOne("RefugioVerde.Models.MetodoDePago", "MetodoDePago")
                        .WithMany("Pagos")
            ...
            modelBuilder.Entity("ReservaComodidad", b =>
                {
                    b.HasOne("RefugioVerde.Models.Comodidad", null)
                        .WithMany()
                        .HasForeignKey("ComodidadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RefugioVerde.Models.Reserva", null)
                        .WithMany()
                        .HasForeignKey("ReservaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ReservaServicio", b =>
                {
                    ...
                    b.HasOne("RefugioVerde.Models.Servicio", null)
                        .WithMany()
